...
Route::get('/admin/dashboard', function () {
    $clients = Client::all();
    $todos = Todo::all();
    return view('dashboard', compact('clients','todos'));
...
Route::middleware('auth')->name('admin.')->group(function () {
    ...
    Route::delete('/admin/clients/delete_file/{client}-{file}', [ClientController::class, 'delete_file'])->name('clients.delete_file');
    Route::delete('/admin/clients/delete_Allfile/{client}', [ClientController::class, 'delete_Allfile'])->name('clients.delete_Allfile');
    Route::get('/admin/clients/downloadFile/{client}/{file}', [ClientController::class, 'downloadFile'])->name('clients.downloadFile');
